...
class Emails:
    def __init__(self,email,motDePasse,Recepteur,NomComplet):
        i = 1
        j = 0
        m = []
        try:
            ...
            for mail in m:
                ...
                msg['From'] = email
                msg['To'] = mail
                msg.attach(MIMEText(f""" {NomComplet} envoyé une demande de congé """))  
        ...
        print('Number of mail sent successfilly  :  ', j)